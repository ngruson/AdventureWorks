...
namespace AW.Services.Product.Core.UnitTests.TestBuilders
{
    ...
    {
        private Entities.Product product = new Entities.Product();
        ...
        public ProductBuilder SizeUnitMeasure(Entities.UnitMeasure sizeUnitMeasure)
        {
        ...
        public ProductBuilder WeightUnitMeasure(Entities.UnitMeasure weightUnitMeasure)
        {
        ...
        public ProductBuilder ProductSubcategory(Entities.ProductSubcategory productSubcategory)
        {
        ...
        public ProductBuilder ProductModel(Entities.ProductModel productModel)
        {
        ...
        public ProductBuilder WithTestValues()
        {
            product = new Entities.Product
            {
                ...
                ProductProductPhotos = new List<Entities.ProductProductPhoto>
                {
                    new Entities.ProductProductPhoto
                    {
                        Primary = true,
                        ProductPhoto = new Entities.ProductPhoto
                        {
