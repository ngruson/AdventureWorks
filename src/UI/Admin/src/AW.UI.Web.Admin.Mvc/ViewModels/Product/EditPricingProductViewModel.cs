...
{
    public class EditPricingProductViewModel : IMapFrom<SharedKernel.Product.Handlers.UpdateProduct.Product>
    {
        ...
        {
            profile.CreateMap<EditPricingProductViewModel, SharedKernel.Product.Handlers.UpdateProduct.Product>()
