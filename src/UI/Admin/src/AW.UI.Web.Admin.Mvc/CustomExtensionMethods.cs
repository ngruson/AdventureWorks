...
static class CustomExtensionMethods
{
    ...
    {
        services.AddAutoMapper(c => c.AddCollectionMappers(), typeof(Program));
    ...
    public static IServiceCollection AddHttpClients(this IServiceCollection services, IConfiguration configuration, OpenIdConnectConfiguration oidcConfig)
    {
        ...
        .AddUserAccessTokenHandler(
            ...
            new[] 
            { 
                configuration["AuthN:ApiScopes:CustomerApiRead"]!,
                configuration["AuthN:ApiScopes:CustomerApiWrite"]!,
            }
        );
