...
using UpdateSalesOrder = AW.UI.Web.Infrastructure.Api.SalesOrder.Handlers.UpdateSalesOrder;
...
namespace AW.UI.Web.Infrastructure.Api.ApiClients
{
    public class SalesOrderApiClient : ISalesOrderApiClient
    {
        ...
        public SalesOrderApiClient(
            ...
            CustomerConverter<SalesOrder.Handlers.GetSalesOrders.Customer, SalesOrder.Handlers.GetSalesOrders.StoreCustomer, SalesOrder.Handlers.GetSalesOrders.IndividualCustomer> converterGetSalesOrders,
            CustomerConverter<SalesOrder.Handlers.GetSalesOrder.Customer, SalesOrder.Handlers.GetSalesOrder.StoreCustomer, SalesOrder.Handlers.GetSalesOrder.IndividualCustomer> converterGetSalesOrder,
